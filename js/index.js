...
const testEnd=()=>{
    const welcomeOne = "<b>Hurraaay"+inputStatus.name.toUpperCase()+"!!!</b> THANKS FOR TAKING THE TEST.";
...
//================================================================
    const stageOneActicityOne=()=>{
        ...
        if(pos>=stageOneOne.length){
            clearTimeout(q);
            imageDisplayPanel.innerHTML="Exam Completed:<i> Congratulations</i>";
		    answerPanel.innerHTML="<b> Your Result is: </b> " +score+" Marks in "+m+ ":"+sec+ "<br><br> <b>Thanks for Writing</b>";
        ...
        imageDisplayPanel.innerHTML="<img src='"+stageOneOne[pos][0] +"' width=400 height=400 style='border:1px groove #000000; box-shadow:4px 4px 4px #000000'>";
        imageDisplayPanel.innerHTML += "<img src='" +stageOneOne[pos][1] +"' width=400 height=400 style='border:1px groove #000000; box-shadow:4px 4px 4px #000000'>";
        imageDisplayPanel.innerHTML+="<img src='"+stageOneOne[pos][2] +"' width=400 height=400 style='border:1px groove #000000; box-shadow:4px 4px 4px #000000'>";
        imageDisplayPanel.innerHTML+="<img src='"+stageOneOne[pos][3] +"' width=400 height=400 style='border:1px groove #000000; box-shadow:4px 4px 4px #000000'>";
...
function quizStopStageThree() {
    ...
    scoreStatus.stageThreeActivityOneAnwser = scores;
    scoreStatus.stageThreeActivityOneTime = m + ':' + sec;
    scoreStatus.stage = 'Stage three';
    scoreStatus.name = inputStatus.name;
    scoreStatus.age = inputStatus.age;
...
function quizStopStageThreeActivityTwo() {
    ...
    scoreStatus.stageThreeActivityTwoAnwser = scores;
    scoreStatus.stageThreeActivityTwoTime = m + ':' + sec;
    scoreStatus.stage = 'Stage three Activity Two';
    scoreStatus.name = inputStatus.name;
    scoreStatus.age = inputStatus.age;
...
const checkStageFiveAnswer = () => {
    ...
    if(answerStageFive==stageFiveActivity[pos][3]){
        score+=2;
        }
            pos++;
